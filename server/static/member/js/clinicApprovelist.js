...
$(function() {
  ...
  function idFormatter(value, row, index) {
    return [
      '<button type="button" class="showclinic btn btn-sm btn-white border-0 text-blue"' +
      'data-id=' + row.clinic_id ,
      ' ">' + value +'</button>'
    ].join('');
  ...
  $('#table1 tbody').on('click','tr td .showclinic', function() {
    ...
    var clinic_id = rowdata.clinic_id;
    var url = "/member/clinicDetail?clinic_id="+clinic_id;
    location.href = url;
  ...
  $("#btnQuery").on("click", function() {
    ...
    var para = {'startTime1':startTime1, 
                'endTime1':endTime1,
                'args':args};
    var url = "/member/clinicApprovelist/";
